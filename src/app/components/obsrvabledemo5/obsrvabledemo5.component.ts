...
@Component({
  selector: 'app-obsrvabledemo5',
  templateUrl: './obsrvabledemo5.component.html',
  styleUrls: ['./obsrvabledemo5.component.css']
})
export class Obsrvabledemo5Component  implements OnInit  {
